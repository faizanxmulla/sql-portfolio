<h2><a href="https://leetcode.com/problems/delete-duplicate-emails">Delete Duplicate Emails</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>Table: <code>Person</code></p>
