<h2><a href="https://leetcode.com/problems/movie-rating">Movie Rating</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Table: <code>Movies</code></p>
