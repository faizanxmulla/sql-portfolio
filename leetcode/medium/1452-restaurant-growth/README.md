<h2><a href="https://leetcode.com/problems/restaurant-growth">Restaurant Growth</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Table: <code>Customer</code></p>
