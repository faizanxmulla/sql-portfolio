<h2><a href="https://leetcode.com/problems/capital-gainloss">Capital Gain/Loss</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Table: <code>Stocks</code></p>
